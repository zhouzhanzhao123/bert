...
flags.DEFINE_integer(
    "max_seq_length", 512,#last 2 model use the length of 512
...
flags.DEFINE_integer("train_batch_size", 8, "Total batch size for training.")#last 2 model use the length of 8
